...
{
    public class GetAllNewVoterQueryHandler:IRequestHandler<GetAllNewVoterQuery,PagedResult<NewVoterResponseDto>>
    {
        ...
        public async Task<PagedResult<NewVoterResponseDto>> Handle(GetAllNewVoterQuery query,CancellationToken cancellationtoken)
        {
