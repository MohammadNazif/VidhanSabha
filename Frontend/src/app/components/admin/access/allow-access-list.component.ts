...
@Component({
  ...
  template: `
    <div class="h-full flex flex-col p-4 gap-4 overflow-hidden">
      <app-page-header title="Edit Access" subtitle="Manage module-level permissions for different roles">
        <button 
...
export class AllowAccessListComponent implements OnInit {
  ...
  savePermissions() {
    ...
    this.crudHandler.handleRequest(
      this.accessService.updatePermission(payload),
      'Success',
