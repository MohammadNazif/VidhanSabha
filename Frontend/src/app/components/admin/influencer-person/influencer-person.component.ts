...
@Component({
  selector: 'app-influencer-person',
  standalone: true,
  ...
  templateUrl: './influencer-person.component.html',
  styleUrl: './influencer-person.component.css'
})
export class InfluencerPersonComponent implements OnInit {
  ...
  formConfig: FormConfig = {
    ...
    fields: [
      ...
      },
      {
        ...
        apiUrl: (desgId: string) => `prabhavshali/getDesgById?id=${desgId}`,
        apiMapper: (data: any) => {
  ...
  handleExport(format: string) {
    ...
    const request = exportFormat === 'excel' ? this.prabhavshaliService.exportToExcel() : this.prabhavshaliService.exportToPdf();
